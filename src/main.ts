...
const downloadLink = import.meta.env.VITE_SCRIBER_DOWNLOAD_LINK || 'https://scriber.aetherpro.us/downloads/Scriber_1.1.8_amd64.deb';
    ...
    <header class="topbar">
      <div class="brand-block">
        <div class="brand-lockup">
          <img class="brand-icon" src="/brand/scriber-icon-64.png" alt="Scriber icon" />
          <img class="brand-wordmark" src="/brand/scriber-wordmark.png" alt="Scriber" />
        </div>
      ...
      <section class="download-section" id="download">
        ...
        <div class="download-grid">
          ...
          <article class="download-card">
            ...
            <pre><code>sudo apt install ./Scriber_1.1.8_amd64.deb</code></pre>
          </article>
          <article class="download-card">
